...
queue_1.default.on('completed', function (job, result) {
    console.log("Job ".concat(job.id, " completed with result:"), result);
});
queue_1.default.on('failed', function (job, error) {
    console.error("Job ".concat(job.id, " failed with error:"), error.message);
});
// Process errors
queue_1.default.on('error', function (error) {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, queue_1.default.close()];
            case 1:
                _a.sent();
                process.exit(0);
                return [2 /*return*/];
